...
public class Player : MovingObject
{
    ...
    public string herramientadeterminada;  //para probar si es la herramienta determinada
    private int leveldet;
    ...
    protected override void Start()
    {
        ...
        herramientadeterminada = GameManager.instance.herramientaDet;  //para ver la hgerramienta que es
        leveldet = GameManager.instance.level;

        //energia.name = "Energia";  //no estoy seguro de esto
    ...
    protected override void AttemptMove<T>(int xDir, int yDir)
    {
        ...
        //Set the foodText to reflect the current player food total.
        vidaText.text = "Vida: " + vida + "   Herramientas: " + herramienta;
        encontradoText.text = "";  //para que al moverlse, el texto del objeto qe ha encontrado se quite
        //herramientaText.text = "Cantidad de herramientas: " + herramienta;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if (other.tag == "Food")
        {
            ...
            GameManager.instance.playerStats.setLife(vida);   //rellena la vida para enviarsela a android
            GameManager.instance.SendPlayerStats();
        }
        ...
        else if (other.tag == "Food2")
        {
            ...
            GameManager.instance.playerStats.setLife(vida);
            GameManager.instance.SendPlayerStats();
        }
        ...
        {
           encontradoText.text = "Nueva herramienta encontrada: " + herramientadeterminada; // +herramientadeterminada;  //no estoy seguro de esto deberia dar la herramienta que cogemos
           ...
           //GameManager.instance.playerStats.setLife(GameManager.instance.playerStats.getLife());
           //GameManager.instance.SendPlayerStats();
       }
    }
    ...
    private void Restart()
    {
        ...
        GameManager.instance.playerStats.setLevel(leveldet);
        GameManager.instance.SendPlayerStats();
    }
